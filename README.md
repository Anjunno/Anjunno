...
* **[휙!(Whik!) - 숏폼 기반 외국어 학습 앱](https://github.com/anjunno/whik)**  `2025 DATA VENTURE 문제 해결 챌린지 - 대상 · 부산광역시장상 수상` 
    * Whik(휙!)은 숏폼 영상 기반 외국어 학습 모바일 앱으로, 짧고 몰입감 있는 콘텐츠를 통해 기존 언어 학습 앱의 높은 이탈률 문제를 해결하고 듣기·말하기·문법을 통합 학습하는 서비스입니다.
...
* **[깜빡(IoT 기반, 1인 가구 에너지 절감 시스템)](https://github.com/anjunno/aiot_smart_home_flutter)**  `전국대학 소프트웨어 성과 공유포럼 - 최우수상 · 동아대학교 총장상 수상` 
